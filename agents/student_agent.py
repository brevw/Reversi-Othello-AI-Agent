...
_10_BY_10_POSITIONAL_WEIGHTS = np.array([
    [100, 50,  20,  10,   1,   1,  10,  20,  50, 100],
    [ 50,   5,   5,   5,   5,   5,   5,   5,   5,  50],
    [ 20,   5,   1,   0,   0,   0,   0,   1,   5,  20],
...
_12_BY_12_POSITIONAL_WEIGHTS = np.array([
    [100,  70,  50,  20,  10,   1,   1,  10,  20,  50,  70, 100],
    [ 70,  10,  10,  10,  10,  10,  10,  10,  10,  10,  10,  70],
    [ 50,  10,   5,   5,   5,   5,   5,   5,   5,   5,  10,  50],
    [ 20,  10,   5,   0,   0,   0,   0,   0,   0,   5,  10,  20],
    [ 10,  10,   5,   0,   0,   0,   0,   0,   0,   5,  10,  10],
    [  1,  10,   5,   0,   0,   0,   0,   0,   0,   5,  10,   1],
    [  1,  10,   5,   0,   0,   0,   0,   0,   0,   5,  10,   1],
    [ 10,  10,   5,   0,   0,   0,   0,   0,   0,   5,  10,  10],
    [ 20,  10,   5,   0,   0,   0,   0,   0,   0,   5,  10,  20],
    [ 50,  10,   5,   5,   5,   5,   5,   5,   5,   5,  10,  50],
